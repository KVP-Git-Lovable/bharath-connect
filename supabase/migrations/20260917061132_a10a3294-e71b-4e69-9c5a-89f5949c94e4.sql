...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.petty_cash_advances TO authenticated;
GRANT ALL ON public.petty_cash_advances TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.petty_cash_transactions TO authenticated;
GRANT ALL ON public.petty_cash_transactions TO service_role;
