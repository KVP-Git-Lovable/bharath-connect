...
export const LEAD_FIELDS: FieldDef[] = [
  ...
  { key: "enquiry_received_date", label: "Enq Rcd Dt", type: "date" },
  { key: "quotation_number", label: "Qtn No", type: "text" },
  { key: "quotation_date", label: "Qtn Date", type: "date" },
  { key: "value_without_gst", label: "Value without GST (₹)", type: "number" },
